...
# ev_parcial1_uribe documentation build
...
from ev_parcial1_uribe import __version__ as release

# -- Project information -----------------------------------------------------

project = "ev_parcial1_uribe"
author = "Kedro"
...
htmlhelp_basename = "ev_parcial1_uribedoc"
...
latex_documents = [
    (
        master_doc,
        "ev_parcial1_uribe.tex",
        "ev_parcial1_uribe Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "ev_parcial1_uribe",
        "Project ev_parcial1_uribe codebase.",
        "Data-Science",
    )
]
